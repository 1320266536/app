package com.bootdo.easemob.util;
...
public class EasemobUtil {
    ...
    public static EasemobResponse RegisterUser(String name, String pwd) {
        ...
        Object newIMUserSingle = imUsers.createNewIMUserSingle(registerUsers);
        String json = dealJson(newIMUserSingle.toString());
    ...
    public static boolean sendMsgFlag( EasemobResponse easemobResponse) {
